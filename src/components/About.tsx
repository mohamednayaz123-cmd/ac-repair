...
export default function About() {
  return (
    <section id="about" className="py-24 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-gray-900">
          {/* Text Content Side */}
          <motion.div
            ...
            className="flex flex-col gap-6 p-8 md:p-12 bg-white/90 backdrop-blur-md rounded-[2.5rem] shadow-2xl border border-white mt-8"
          >
            <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-2">
              <div className="flex items-center gap-3 bg-white p-4 rounded-xl border border-gray-100 shadow-sm transition-colors hover:border-brand-blue-200">
                <div className="w-10 h-10 bg-brand-blue-50 text-brand-blue-600 rounded-lg flex items-center justify-center shadow-sm">
                  <Users className="w-5 h-5" />
                </div>
                <span className="font-bold text-sm text-gray-800">Expert Technicians</span>
              </div>
              <div className="flex items-center gap-3 bg-white p-4 rounded-xl border border-gray-100 shadow-sm transition-colors hover:border-brand-orange-200">
                <div className="w-10 h-10 bg-brand-orange-50 text-brand-orange-500 rounded-lg flex items-center justify-center shadow-sm">
