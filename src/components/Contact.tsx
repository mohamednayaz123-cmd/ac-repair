      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-gray-600">
            Need urgent repair service or a free quotation? Reach out to us
            directly or fill the form, and our tech support will connect with
            you.
          </p>
        </div>
            ...
            <div className="relative z-10 space-y-8">
              <div>
                ...
                <p className="text-brand-blue-200">
                  We are ready to fix your appliances.
                </p>
              </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    <p className="text-sm text-brand-blue-200 font-medium mb-1">
                      Phone
                    </p>
                    <a
                      href="tel:+919686445593"
                      className="text-xl font-bold hover:text-brand-orange-400 transition-colors"
                    >
                      +91 96864 45593
                    </a>
                  </div>
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div>
                  ...
                  <input
                    ...
                    id="contact_name"
                    name="contact_name"
                    className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-brand-blue-500 focus:bg-white transition-colors"
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-brand-blue-500 focus:bg-white transition-colors cursor-pointer text-gray-700"
                  required
                  defaultValue=""
                >
                  ...
                  <option value="GeneralQuery">
                    General Info / Quoatation
                  </option>
                </select>
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={4}
                  className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-brand-blue-500 focus:bg-white transition-colors resize-none"
              ...
              <button
                type="submit"
                className="w-full flex justify-center items-center gap-2 px-6 py-4 bg-brand-blue-600 text-white rounded-lg font-bold text-lg hover:bg-brand-blue-700 transition-colors shadow-lg shadow-brand-blue-600/30 group"
              >
                Send Request{" "}
